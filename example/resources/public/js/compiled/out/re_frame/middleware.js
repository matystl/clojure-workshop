...
if(!((function (){var G__25484 = app_db;
if(G__25484){
...
return G__25484.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__25484.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__25484);
} else {
return false;
}
}
...
while (G__25489__i < G__25489__a.length) {G__25489__a[G__25489__i] = arguments[G__25489__i + 0]; ++G__25489__i;}
  args = new cljs.core.IndexedSeq(G__25489__a,0);
} 
return re_frame$middleware$path__delegate.call(this,args);};
re_frame$middleware$path.cljs$lang$maxFixedArity = 0;
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__25490){
var args = cljs.core.seq(arglist__25490);
...
return cljs.core.get_in.call(null,new_db,p1__25491_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__25492_SHARP_){
return cljs.core.get_in.call(null,db,p1__25492_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
var G__25493__i = 0, G__25493__a = new Array(arguments.length -  2);
while (G__25493__i < G__25493__a.length) {G__25493__a[G__25493__i] = arguments[G__25493__i + 2]; ++G__25493__i;}
  in_paths = new cljs.core.IndexedSeq(G__25493__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__25494){
var f = cljs.core.first(arglist__25494);
arglist__25494 = cljs.core.next(arglist__25494);
var out_path = cljs.core.first(arglist__25494);
var in_paths = cljs.core.rest(arglist__25494);
...
//# sourceMappingURL=middleware.js.map?rel=1446435319571