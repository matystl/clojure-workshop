...
var G__25275 = o;
(G__25275[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__25276__delegate = function (args){
...
while (G__25277__i < G__25277__a.length) {G__25277__a[G__25277__i] = arguments[G__25277__i + 0]; ++G__25277__i;}
  args = new cljs.core.IndexedSeq(G__25277__a,0);
} 
...
var old_25279 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_25279))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_25279)].join(''):class$));
} else {
}
...
var G__25282 = jsprops;
(G__25282["defaultValue"] = value);

(G__25282["onChange"] = ((function (G__25282,v,value,on_change){
return (function (p1__25280_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25280_SHARP_);
});})(G__25282,v,value,on_change))
);
...
var vec__25284 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25284,(0),null);
var id = cljs.core.nth.call(null,vec__25284,(1),null);
var class$ = cljs.core.nth.call(null,vec__25284,(2),null);
...
var temp__4128__auto__ = (function (){var G__25286 = cljs.core.meta.call(null,v);
var G__25286__$1 = (((G__25286 == null))?null:reagent.impl.template.get_key.call(null,G__25286));
return G__25286__$1;
})();
if((temp__4128__auto__ == null)){
...
var jsprops = {"argv": v};
var G__25288_25289 = v;
var G__25288_25290__$1 = (((G__25288_25289 == null))?null:reagent.impl.template.key_from_vec.call(null,G__25288_25289));
var G__25288_25291__$2 = (((G__25288_25290__$1 == null))?null:(jsprops["key"] = G__25288_25290__$1));
...
var p = (function (){var temp__4128__auto__ = (function (){var G__25294 = cljs.core.meta.call(null,argv);
var G__25294__$1 = (((G__25294 == null))?null:reagent.impl.template.get_key.call(null,G__25294));
return G__25294__$1;
})();
if((temp__4128__auto__ == null)){
return jsprops;
...
var G__25295 = (((jsprops == null))?{}:jsprops);
(G__25295["key"] = key);
...
var n__19045__auto___25296 = a.length;
var i_25297 = (0);
while(true){
if((i_25297 < n__19045__auto___25296)){
(a[i_25297] = reagent.impl.template.as_element.call(null,(a[i_25297])));

var G__25298 = (i_25297 + (1));
i_25297 = G__25298;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__19045__auto___25299 = a.length;
var i_25300 = (0);
while(true){
if((i_25300 < n__19045__auto___25299)){
var val_25301 = (a[i_25300]);
if((cljs.core.vector_QMARK_.call(null,val_25301)) && ((reagent.impl.template.key_from_vec.call(null,val_25301) == null))){
(o["no-key"] = true);
} else {
}

(a[i_25300] = reagent.impl.template.as_element.call(null,val_25301));

var G__25302 = (i_25300 + (1));
i_25300 = G__25302;
continue;
} else {
}
...
var G__25304 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25304) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__25304){
...
//# sourceMappingURL=template.js.map?rel=1446435319185